...
module.exports = function () {
  var isVisible = arguments.length <= 0 || arguments[0] === undefined ? function () {
  ...
  return {
    ...
    onClient: function onClient() {
      ...
      var resolvers = generateResolvers('app', configCopy.app, function () {
        ...
        var module = _ref$module === undefined ? {} : _ref$module;
    ...
    onServer: function onServer() {
      ...
      var resolvers = generateResolvers('app', configCopy.app, function () {
        ...
        var _ref2$module = _ref2.module;
        var module = _ref2$module === undefined ? {} : _ref2$module;
